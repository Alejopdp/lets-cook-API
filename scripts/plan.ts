...
export const getMockPlans = () => {
    ...
    const variantWithoutGluten6 = new PlanVariantWithRecipe(
        2,
        2,
        new PlanSku("PLCARNGL2"),
        "Carnívoro 2 sin gluten",
        30,
        20,
        [],
        "PLCARNGL2 Desc"
    );
    const variantWithoutGluten7 = new PlanVariant(
        new PlanSku("PLCER1"),
    ...
    const variantWithoutGluten8 = new PlanVariant(
        new PlanSku("PLVIN2"),
        "development/plans/Plan_test/Plan_test.png",
        15,
        [],
    ...
    const plan5: Plan = Plan.create(
        ...
        [],
        Locale.es,
        new PlanSlug("Plan Vegetariano - 2"),
        true,
        "lineal",
        "linealColor"
    );
