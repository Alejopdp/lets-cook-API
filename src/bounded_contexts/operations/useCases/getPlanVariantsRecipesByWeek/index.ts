...
export const getPlanVariantsRecipesByWeekList: GetPlanVariantsRecipesByWeekList = new GetPlanVariantsRecipesByWeekList(mongoosePlanRepository, mongooseRecipeRepository, mongooseWeekRepository);
export const getPlanVariantsRecipesByWeekListController: GetPlanVariantsRecipesByWeekListController = new GetPlanVariantsRecipesByWeekListController(getPlanVariantsRecipesByWeekList);
