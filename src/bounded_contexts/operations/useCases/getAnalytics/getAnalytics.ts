...
export class GetAnalytics {
    ...
    public async execute(dto: GetAnalyticsDto): Promise<any> {
        ...
        return {
            ...
            currentWeekKitsForCooking,
            nextWeekKitsForCooking,
            kitsForCookingPercentage: Math.round((nextWeekKitsForCooking / currentWeekKitsForCooking - 1) * 100),
            ...
            currentWeekNumberOfPersons,
            nextWeekNumberOfPersons,
            numberOfPersonsPercentage: Math.round((nextWeekNumberOfPersons / currentWeekNumberOfPersons - 1) * 100),
            currentWeekNumberOfPersonsAvg,
            nextWeekNumberOfPersonsAvg,
            numberOfPersonsAvgPercentage: Math.round((nextWeekNumberOfPersonsAvg / currentWeekNumberOfPersonsAvg - 1) * 100),
            currentWeekAdditionalOrdersQty,
            nextWeekAdditionalOrdersQty,
            additionalOrdersQtyPercentage: Math.round((nextWeekAdditionalOrdersQty / currentWeekAdditionalOrdersQty - 1) * 100),
            currentWeekNewCustomersQty,
            nextWeekNewCustomersQty,
            newCustomersQtyPercentage: Math.round((nextWeekNewCustomersQty / currentWeekNewCustomersQty - 1) * 100) || 0,
            currentWeekActiveCustomers,
            nextWeekActiveCustomers,
