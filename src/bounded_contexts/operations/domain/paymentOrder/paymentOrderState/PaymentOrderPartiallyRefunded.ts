...
export class PaymentOrderPartiallyRefunded implements IPaymentOrderState {
    title: string;
    humanTitle: string;
    color: string;

    constructor() {
        this.title = "PAYMENT_ORDER_PARTIALLY_REFUNDED";
        this.humanTitle = "Orden parcialmente reembolsada";
        this.color = "green";
    }
