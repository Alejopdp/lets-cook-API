...
export class PaymentRejectedWalletLog implements WalletMovementLog {
    ...
    constructor(customerId: CustomerId, createdAt: Date, amount: number) {
        this._type = WalletMovementLogType.PAYMENT_REJECTED;
        this._title = "";
        this._description = "";
    ...
    public getTitle(locale: Locale): string {
        switch (locale) {
            case Locale.en:
                return "There is a rejected payment";
            case Locale.ca:
                return "Hi ha un pagament rebutjat";
            case Locale.es:
                return "Hay un pago rechazado";
            default:
                return "Hay un pago rechazado"
        }
    }
