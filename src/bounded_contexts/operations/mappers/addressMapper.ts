...
export class AddressMapper implements Mapper<Address> {
    public toDomain(raw: any): Address {
        return new Address(raw.latitude, raw.longitude, raw.addressName, raw.addressFullName, raw.addressDetails, raw.identification, raw.deliveryTime, new AddressId(raw._id));
    }
