...
import { MomentTimeService } from "../bounded_contexts/operations/application/timeService/momentTimeService";
    ...
    <html lang="es">
        ...
        <tbody>
          <tr>
            <td>
              <!--  -->
              <table align="center" border="0" bgcolor="#F4EBD7" class="mlContentTable mlContentTableDefault" cellpadding="0" cellspacing="0" width="640">
                <tbody>
                  <tr>
                    <td class="mlContentTableCardTd">
                      <table
                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" id="imageBlock-4">
                                              <img
                                                src="https://bucket.mlcdn.com/a/1966/1966360/images/1c2fd22511cba065dc9822c3a0fba1e9d15ca7c6.jpeg"
                                                border="0"
                                                alt=""
                                                width="640"
                                                style="display: block"
                                      ...
                                      <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                                        <tbody>
                                          <tr>
                                            <td align="center">
                                              <img
                                                src="https://bucket.mlcdn.com/a/1966/1966360/images/95cda45a4a2ecf49f07ee78da3919ea569a0561e.png/168efaa6fde5dde20fecea62e46b771939d74381.png"
                                                id="logoBlock-6"
                                                border="0"
                                                alt=""
                                                width="560"
                                        ...
                                        <tbody>
                                          <tr>
                                            <td
                                              ...
                                              "
                                            >
                                              ${MomentTimeService.getDdMmYyyy(new Date())}
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
                                  ...
                                  <tr>
                                    <td align="center" class="mlContentOuter">
                                      <table
                                        ...
                                        align="center"
                                        width="560"
                                        style="border-top: 1px solid #e83429; border-collapse: initial"
                                        class="mlContentTable"
                                      >
                                        <tbody>
                                          <tr>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td
                                              class="bodyTitle"
                                              id="bodyText-12"
                                              style="font-family: Georgia, serif; font-size: 18px; line-height: 100%; color: #e83429"
                                            >
                                              <p style="margin-top: 0px; margin-bottom: 0px; line-height: 100%">
                                                <strong>Resumen del pedido </strong><br />${dto.orders.map( (order) => `${order.plan.name}<br />${order.getPlanVariantLabel(order.planVariantId )}<br />`)}</p>
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
                                      ...
                                      <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                                        <tbody>
                                          <tr>
                                            ...
                                            >
                                              <p style="margin-top: 0px; margin-bottom: 0px; line-height: 100%">
                                                <strong>Fecha de entrega </strong><br />${dto.shippingDate}
                                              </p>
                                            </td>
                                          </tr>
                                        </tbody>
                                      ...
                                      <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                                        <tbody>
                                          <tr>
                                            ...
                                            >
                                              <p style="margin-top: 0px; margin-bottom: 0px; line-height: 100%">
                                                <strong>Nombre y dirección de envío </strong><br />${dto.shippingCustomerName}<br />${dto.shippingAddressName}<br /><a
                                                  href="tel:${dto.phoneNumber}"
                                                  style="word-break: break-word; font-family: Georgia, serif; color: #e83429; text-decoration: underline"
                                                  >${dto.phoneNumber}</a>
                                              </p>
                                            </td>
                                          </tr>
                                      ...
                                      <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                                        <tbody>
                                          <tr>
                                            ...
                                            >
                                              <p style="margin-top: 0px; margin-bottom: 0px; line-height: 100%">
                                                <strong>Detalle</strong> <br /><strong></strong>Planes: ${Math.round((dto.totalAmount - dto.foodVAT -
                                                dto.shippingCost) * 1e12) / 1e12}€<br />Envío (¡Sin cargo en Barcelona y Madrid!): ${dto.shippingCost}€<br />Descuento:
                                                ${dto.discountAmount}€<br />IVA (10%): ${dto.foodVAT}€<br />Total: ${dto.totalAmount}€
                                              </p>
                                            </td>
              ...
              <!--  -->
              <table align="center" border="0" bgcolor="#531F2B" class="mlContentTable mlContentTableDefault" cellpadding="0" cellspacing="0" width="640">
                <tbody>
                  <tr>
                    <td class="mlContentTableCardTd">
                      <table
                                        ...
                                        <tbody>
                                          <tr>
                                            <td
                                              class="bodyTitle"
                                              id="bodyText-26"
                                              style="font-family: Georgia, serif; font-size: 18px; line-height: 150%; color: #f4ebd7"
                                            >
                                              <p style="margin-top: 0px; margin-bottom: 0px; line-height: 150%">
                                                <span style="font-size: 28px"
                                                  >Si tienes alguna duda,&nbsp;puedes<br />ponerte en contacto&nbsp;con nosotros <br />por los canales
                                                  habituales</span
                                                >
                                              </p>
                                            </td>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td
                                              class="bodyTitle"
                                              id="bodyText-28"
                                              style="font-family: Georgia, serif; font-size: 14px; line-height: unset; color: #f4ebd7"
                                            >
                                              <p style="margin-top: 0px; margin-bottom: 0px; line-height: unset">
                                                <a
                                                  href="mailto:info@letscook.es"
                                                  style="word-break: break-word; font-family: Georgia, serif; color: #f4ebd7; text-decoration: underline"
                                                  >info@letscook.es</a
                                                >
                                                | WhatsApp
                                                <a
                                                  href="tel:+34 653 65 05 83"
                                                  style="word-break: break-word; font-family: Georgia, serif; color: #f4ebd7; text-decoration: underline"
                                                  >+34 653 65 05 83</a
                                                >
                                              </p>
                                  ...
                                  <tr>
                                    <td align="center" class="mlContentOuter">
                                      <table
                                        ...
                                        align="center"
                                        width="560"
                                        style="border-top: 1px solid #f4ebd7; border-collapse: initial"
                                        class="mlContentTable"
                                      >
                                        <tbody>
                                          <tr>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td
                                              class="bodyTitle"
                                              id="bodyText-32"
                                              style="font-family: Georgia, serif; font-size: 13px; line-height: unset; color: #f4ebd7"
                                            >
                                              <p style="margin-top: 0px; margin-bottom: 0px; line-height: unset">
                                                <u
                                                  ><span
                                                    ><a
                                                      href="https://www.instagram.com/letscook.es/"
                                                      target="_blank"
                                                      style="word-break: break-word; font-family: Georgia, serif; color: #f4ebd7; text-decoration: underline"
                                                      >Instagram</a
                                                    ></span
                                      ...
                                      <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                                        <tbody>
                                          <tr>
                                            <td align="center">
                                              <img
                                                src="https://bucket.mlcdn.com/a/1966/1966360/images/af99df886d3eff45e557eacd6ad961df7be26c21.png/7b26d161668166db95ff15a8b4f52966fb2cee5e.png"
                                                id="logoBlock-34"
                                                border="0"
                                                alt=""
                                                width="560"
...
export const updateEmailTemplate = (url: string, locale: Locale) => {
    const texts: { [locale: string]: { hello: string; text_1: string; text_2: string; here: string } } = {
        [Locale.es]: {
            hello: "Hola!",
            text_1: "Has solicitado un cambio de correo electrónico, puedes entrar ",
            text_2: " para confirmar el cambio. El enlace estará disponible durante 1 hora. Si no logras hacer el cambio, deberías solicitarlo de nuevo.",
            here: "aquí",
        },
        [Locale.en]: {
            hello: "Hello!",
            text_1: "You have requested to change your e-mail address. Please, enter ",
            text_2: " to confirm. The link will be available for 1 hour. If you are unable to make the change, please make the request again.",
            here: "here",
        },
        [Locale.ca]: {
            hello: "Hola!",
            text_1: "Has sol·licitat un canvi d'adreça electrònica, pots entrar ",
            text_2: " per confirmar-lo. L'enllaç estarà disponible durant 1 hora. Si no aconsegueixes realitzar els canvis, hauries de demanar un de nou.",
            here: "aquí",
        },
    };
        ...
        <div role="article" aria-label="Tu Baul- compra confirmada" lang="en" style="background-color: transparent ; color: #2b2b2b; font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 1000px; padding: 40px 16px 40px 16px;">
            ...
            <main>
                ...
                <div style="background-color: white; border-radius: 64px; padding: 32px 40px;">
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="600" align="center" role="presentation"><tr><td style="background-color: ghostwhite;font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; padding: 24px 48px 24px 48px;">
                    <![endif]-->
                    <h1 style="color: #00a555; font-size: 24px; font-weight: 800; line-height: 24px; margin: 16px 0;">
                    ${texts[locale].hello}
                    </h1>
                        
                    <div style="background-color: white; border-radius: 64px; padding: 8px 40px;">  
                    <p>${texts[locale].text_1}<a href="${url}">${texts[locale].here}</a>${texts[locale].text_2}</p>
