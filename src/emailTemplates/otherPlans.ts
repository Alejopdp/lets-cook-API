...
export const otherPlans = (
    ...
    hasIndicatedRestrictions: boolean = false
) => {
    return `
...
<head>
  ...
  <meta name="x-apple-disable-message-reformatting">
    <!--[if !mso]><!-->
  <style type="text/css">@import url("https://static.mailerlite.com/assets/plugins/groot/modules/includes/groot_fonts/import.css?version=1632227");</style>
  <!--<![endif]-->
		...
		<td align="center" style="padding: 0px 40px;" class="mlContentOuter">
			...
			<table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                ...
                <td align="center" id="imageBlock-12">
                  <img src="https://bucket.mlcdn.com/a/1966/1966360/images/50b6be511f76fe66b9d0e30648f30a113eca18b6.jpeg/61aace88eb5337e65e9b2c9380423d6043b34b12.jpeg" border="0" alt="" width="267" style="display: block;">
                </td>
								<!--[if !mso]><!-- -->
								<td height="1" width="25"></td>
								<!--<![endif]-->
...
<p style="margin-top: 0px; margin-bottom: 0px;">Combate el fondwaste</p></td>
      				...
      				<tr>
      					<td align="right" class="bodyTitle" style="font-family: 'Lato', Arial, Helvetica, sans-serif; font-size: 12px; line-height: 100%; color: #ffffff;">
        					<a href="http://app.mailerlite.com/subscription/test_unsubscribe/43200376/1966360" style="color: #ffffff; text-decoration: underline;">
