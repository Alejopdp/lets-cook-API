export const planAhorroMailTemplate = (name: string) => {
    return `
...
<head>
  ...
  <meta name="x-apple-disable-message-reformatting">
    <!--[if !mso]><!-->
  <style type="text/css">@import url("https://static.mailerlite.com/assets/plugins/groot/modules/includes/groot_fonts/import.css?version=1635939");</style>
  <!--<![endif]-->
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" width="640" style="width: 640px; min-width: 640px;" class="mlContentTable">
	<tr>
		<td align="center" style="padding: 0px 40px;" class="mlContentOuter">
  		...
  		<table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
  			<tr>
  				<td class="bodyTitle" id="bodyText-6" style="font-family: 'Lato', Arial, Helvetica, sans-serif; font-size: 14px; line-height: 150%; color: #6f6f6f;"><p style="margin-top: 0px; margin-bottom: 10px; line-height: 150%;"><strong><span style="color: rgb(40, 167, 69);">Hola ${name}, ¡gracias por tu compra!</span></strong><span style="color: rgb(127, 140, 141);"><br></span></p>
<p style="margin-top: 0px; margin-bottom: 0px; line-height: 150%;"><span style="color: rgb(40, 167, 69);"><span style="color: rgb(0, 0, 0);"><span style="color: rgb(127, 140, 141);">¡Mmmm qué buena pinta! Gracias por apuntarte a este planazo. A partir de ahora, con Let’s Cook, tu rutina y la de los tuyos será mucho más divertida y saludable. Te lo pondremos fácil para que puedas cocinar bueno y rico, aprender nuevas recetas y saborear platos con mucha chispa. ¿Pinta bien no?</span></span><br></span></p></td>
  			</tr>
  		</table>
		...
		<td align="center" style="padding: 0px 40px;" class="mlContentOuter">
			...
			<table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
                ...
                <td align="center" id="imageBlock-8">
                  <img src="https://bucket.mlcdn.com/a/1966/1966360/images/50b6be511f76fe66b9d0e30648f30a113eca18b6.jpeg/cc2979c20d02e2d340e03d4cd110b06387f764d5.jpeg" border="0" alt="" width="267" style="display: block;">
                </td>
							</tr>
							<tr>
						...
						<p style="margin-top: 0px; margin-bottom: 10px; font-size: 14px; line-height: 150%; color: #6f6f6f;">Los lunes recibirás por email las recetas de tus kits. Además, <strong>en la etiqueta de los kits encontrarás 2 códigos QR: uno con la receta paso a paso y otro con la video-receta.</strong> Como ves, enviamos las recetas digitalmente, así reducimos al máximo el papel y cuidamos de nuestro planeta.<br></p>
<p style="margin-top: 0px; margin-bottom: 10px; font-size: 14px; line-height: 150%; color: #6f6f6f;">De cara a las próximas semanas, si quieres saltar una semana, cancelar o cambiar algo en tu plan, puedes hacerlo antes de <strong>las 23.59 cada viernes</strong> desde tu cuenta en nuestra web.</p>
<p style="margin-top: 0px; margin-bottom: 10px; font-size: 14px; line-height: 150%; color: #6f6f6f;"><em>¿Alguna duda? </em></p>
<p style="margin-top: 0px; margin-bottom: 0px; font-size: 14px; line-height: 150%; color: #6f6f6f;">En Let’s Cook queremos ayudarte para que puedas disfrutar al máximo de buenos y ricos momentos con los tuyos. Así que si tienes alguna pregunta no dudes en contactar con nosotros.</p>
...
<p style="margin-top: 0px; margin-bottom: 0px;">Combate el fondwaste</p></td>
      				...
      				<tr>
      					<td align="right" class="bodyTitle" style="font-family: 'Lato', Arial, Helvetica, sans-serif; font-size: 12px; line-height: 100%; color: #ffffff;">
        					<a href="http://app.mailerlite.com/subscription/test_unsubscribe/43254748/1966360" style="color: #ffffff; text-decoration: underline;">
